...
#### De 02/2019 à aujourd'hui

Leader technique au sein de la Direction IT Expérience Client amenant la culture DevOps envers 120 développeurs / scrum master.

Rôle de responsable technique Ops : étroite collaboration avec le Responsable Technique principal de la direction et la Direction Architecture (150 collaborateurs) comprenant des équipes produits (mutualisés) et les équipes Ops.

Principal ingénieur fiabilité de site sur le parc Linux.
La production Cdiscount compte 5000 serveurs physiques répartis dans 2 datacentres en France et un CDN avec 6 points de présences. Et quelques projets dans le cloud Azure.

Direction IT Expérience Client en charge de:
* site PC et mobile [www.cdiscount.com](https://www.cdiscount.com)
* application mobile
* order.cdiscount.com
* clients.cdiscount.com

Missions principales axées autour de :
* autonomisation des développeurs sur les aspects Ops, Perf et Sécu
...
#### De 07/2018 au 02/2019

Promotion au poste d'ingénieur architecte à la DSI Orange Applications for Business (équipe de 30 collaborateurs).

Interconnecter les outils des directions métiers et ceux de de la DSI au niveau des architectures : Application, Data et Infrastructure.
...
Assets : TOGAF, Git, Docker, VMware, Nginx, Debian, OWASP ZAP, MySQL, SaltStack, PHP, Scrum, DDD, TDD, DAT

### Ingénieur Développement et Production chez Orange Business Services

#### De 08/2015 au 07/2018
...
Force de proposition et parfois aMOA sur les projets de la DSI.

Formation continue des ingénieurs de la direction sur les travaux réalisés.

Assets : Docker, PHP, MySQL, Nginx, Debian, Git, Jenkins, Sonar, Gitlab, Zend Framework, PHPUnit, Slim framework, Elasticsearch, Filebeat, Logstash, Grok, Kiban, Jira, DDD, TDD, DAT, Javascript, jQuery, Doctrine Framework, Bash

### Ingénieur d'Etudes du Système d'Information chez Orange Business Services

#### De 09/2013 au 07/2015

Fin alternance avec écriture d'un mémoire : Industrialisation informatique des processus de mouvements aux Ressources Humaines. Etude approfondie du métier RH, du SIRH en entreprise et démonstration d'une application technique, technologique et organisation humaine.
...
L'entreprise a fortement souhaité me faire revenir pour de nouvelles missions. Ce que j'ai accepté car apprenant beaucoup de mon maître de stage ingénieur en génie logiciel.

Développement essentiellement PHP et Javascript sur des site internet.
...
Date | Nom | Authorité de certification | Référence
-----|------|-------------------|----------
...
Année | Diplôme | Mention | Ecole
-----|--------------|---------|-------
2015 | Titre Niveau I - Expert en Informatique et Système d'Information | Félicitations | [EPSI Bordeaux](https://www.epsi.fr/)
2013 | Titre Niveau II - Administrateur système réseau et base de données | Félicitations | EPSI Bordeaux
2012 | BTS Informatique de Gestion, Spécialité Mathématiques | Bien | EPSI Bordeaux
2008 | Bac Scientifique SVT, Spécialité Mathématiques | | [Lycée Saint Joseph de Tivoli](https://tivoli-33.org/)

## Expériences de bénévolat

### Entraîneur club cyclisme, route et piste

#### De 10/2017 à aujourd'hui
